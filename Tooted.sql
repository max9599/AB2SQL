...
COMMENT ON VIEW Toodete_lopetamine IS 'Süsteem kuvab tooteid mis on seisundis "Aktiivne" või "Mitteaktiivne", et anda subjektile võimaluse näha tooteid, mida ta saab lõpetada.';
