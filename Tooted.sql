...
-- Indexid DROP laused
DROP INDEX IF EXISTS Isik_IDX_seisundi_liik_kood CASCADE;
DROP INDEX IF EXISTS Isik_IDX_riik_kood CASCADE;
DROP INDEX IF EXISTS Isik_IDX_perenimi_eesnimi CASCADE;
DROP INDEX IF EXISTS Klient_IDX_seisundi_liik_kood CASCADE;
DROP INDEX IF EXISTS Tootaja_IDX_amet_kood CASCADE;
DROP INDEX IF EXISTS Tootaja_IDX_seisundi_liik_kood CASCADE;
DROP INDEX IF EXISTS Toode_IDX_riik_kood CASCADE;
DROP INDEX IF EXISTS Toode_IDX_seisundi_liik_kood CASCADE;
DROP INDEX IF EXISTS Toode_IDX_tootaja_id CASCADE;
DROP INDEX IF EXISTS Toote_kategooria_omamine_IDX_kategooria_kood CASCADE;
...
(
	...
	nimetus d_nimetus,
	kirjeldus d_kirjeldus,
	CONSTRAINT Isiku_seisundi_liik_PK_seisundi_liik_kood PRIMARY KEY (seisundi_liik_kood),
...
(
	...
	nimetus d_nimetus,
	kirjeldus d_kirjeldus,
	CONSTRAINT Kliendi_seisundi_PK_seisundi_liik_kood PRIMARY KEY (seisundi_liik_kood),
...
(
	...
	nimetus d_nimetus,
	kirjeldus d_kirjeldus,
	CONSTRAINT Toote_seisundi_liik_PK_seisundi_liik_kood PRIMARY KEY (seisundi_liik_kood),
...
(
	...
	nimetus d_nimetus,
	kirjeldus d_kirjeldus,
	CONSTRAINT Tootaja_seisundi_liik_PK_seisundi_liik_kood PRIMARY KEY (seisundi_liik_kood),
...
(
	...
	nimetus d_nimetus,
	kirjeldus d_kirjeldus,
	CONSTRAINT Toote_kategooria_PK_kategooria_kood PRIMARY KEY (kategooria_kood),
...
(
    ...
    riik_kood char(3)  NOT NULL,
    seisundi_liik_kood smallint NOT NULL DEFAULT 1,
    ...
    CONSTRAINT Isik_CHK_Synni_kp CHECK (sunni_kp > '31-12-1900' AND sunni_kp < '31-12-2100'),
    ...
    CONSTRAINT Isik_CHK_Reg_Aeg_SuuremVordne_Synni_Kp CHECK (reg_aeg >= sunni_kp),
    CONSTRAINT Isik_FK_seisundi_liik_kood FOREIGN KEY (seisundi_liik_kood) REFERENCES Isiku_seisundi_liik (seisundi_liik_kood) ON DELETE No Action ON UPDATE Cascade,
    CONSTRAINT Isik_FK_riik_kood FOREIGN KEY (riik_kood) REFERENCES Riik (riik_kood) ON DELETE No Action ON UPDATE Cascade
)
;

CREATE INDEX Isik_IDX_seisundi_liik_kood ON Isik (seisundi_liik_kood ASC);
...
(
	...
	CONSTRAINT Klient_FK_seisundi_liik_kood FOREIGN KEY (seisundi_liik_kood) REFERENCES Kliendi_seisundi_liik (seisundi_liik_kood) ON DELETE No Action ON UPDATE Cascade,
    CONSTRAINT Klient_FK_isik_id FOREIGN KEY (isik_id) REFERENCES Isik (isik_id) ON DELETE Cascade ON UPDATE No Action
)
;

CREATE INDEX Klient_IDX_seisundi_liik_kood ON Klient (seisundi_liik_kood ASC);
...
(
    ...
    CONSTRAINT Tootaja_FK_seisundi_liik_kood FOREIGN KEY (seisundi_liik_kood) REFERENCES Tootaja_seisundi_liik (seisundi_liik_kood) ON DELETE No Action ON UPDATE Cascade,
...
CREATE INDEX Tootaja_IDX_seisundi_liik_kood ON Tootaja (seisundi_liik_kood ASC);
...
(
    ...
    CONSTRAINT Toode_FK_seisundi_liik_kood FOREIGN KEY (seisundi_liik_kood) REFERENCES Toote_seisundi_liik (seisundi_liik_kood) ON DELETE No Action ON UPDATE Cascade,
    CONSTRAINT Toode_FK_tootaja_id FOREIGN KEY (tootaja_id) REFERENCES Tootaja (isik_id) ON DELETE No Action ON UPDATE Cascade
)
;

CREATE INDEX Toode_IDX_riik_kood ON Toode (riik_kood ASC);
CREATE INDEX Toode_IDX_seisundi_liik_kood ON Toode (seisundi_liik_kood ASC);
CREATE INDEX Toode_IDX_tootaja_id ON Toode (tootaja_id ASC);

CREATE TABLE Toote_kategooria_omamine
(
	toode_kood varchar(100)	 NOT NULL,
	kategooria_kood smallint NOT NULL,
	CONSTRAINT Toote_kategooria_omamine_PK_toode_kood_kategooria_kood PRIMARY KEY (toode_kood,kategooria_kood),
	...
	CONSTRAINT Toote_kategooria_omamine_FK_kategooria_kood FOREIGN KEY (kategooria_kood) REFERENCES Toote_kategooria (kategooria_kood) ON DELETE Cascade ON UPDATE Cascade
)
;

CREATE INDEX Toote_kategooria_omamine_IDX_kategooria_kood ON Toote_kategooria_omamine (kategooria_kood ASC);
